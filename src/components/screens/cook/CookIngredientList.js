...
class CookIngredientList extends Component {
  constructor() {
    ...
    this.state = {
      ...
      supplies: [
        {name: 'Tomato', rating: '2', quantity: '27'},
        {name: 'Cucumber', rating: '4', quantity: '19'},
        {name: 'Salt', rating: '5', quantity: '100'},
        {name: 'Pepper', rating: '5', quantity: '100'},
      ],
    };
  }
  ...
  componentWillMount = async () => {
    // this is a function to do something before the componenet renders
  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        <Text style={{fontSize: 40, textAlign: 'center', marginBottom: 15}}>
          Ingredient List{' '}
        </Text>
