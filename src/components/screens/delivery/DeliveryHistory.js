    ...
    render(){
        return(
            ...
            <View style={{justifyContent: 'center'}}>
                <Text style={{fontSize: 35, textAlign: 'center'}}>Delivery History</Text>
            </View>
            ...
            <View style={{marginVertical: 10}}>
                ...
                <View style={{marginHorizontal: 10, flexDirection: 'row', flexWrap: 'wrap', borderWidth: 1, padding: 7, backgroundColor:'white'}}>
                    ...
                    <View style={{ textAlign: 'center', width: '33%'}}>
                        <Text style={{textAlign: 'center', fontSize: 20}}>Your Rating</Text>
                    </View>
                    ...
                    this.state.customers.map( (customer) =>{
                        return ( 
                            <View style={{marginHorizontal: 10, flexDirection: 'row', flexWrap: 'wrap', borderWidth: 1, padding: 3}}>
                                ...
                                <View style={{ width: '33%'}}>
                                <Text
                                    style={{alignSelf:'center',  padding:10, fontSize: 20, color: 'black', textAlign: 'center'}}>{customer.yourRating}/5</Text>
                                </View>
                            </View>
